# @repo/solid-a11y-date-input

Solid.js wrapper components for the natural date picker web components.

## Installation

```bash
pnpm add @repo/solid-a11y-date-input
```
...
```tsx
import { createSignal } from 'solid-js';
import { DateRangeInput } from '@repo/solid-a11y-date-input';
